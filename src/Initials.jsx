        ...
        <div className="relative">
            ...
            <div className="hidden lg:flex lg:flex-col space-y-5 mt-16 w-max">
                <a href="#about" className="text-xs text-white flex items-center group">
                    <span className="h-px w-8 bg-slate-600 mr-4 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none"></span>
            ...
            <div className="mt-8 flex gap-5 text-emerald-300 lg:absolute lg:-bottom-60">
